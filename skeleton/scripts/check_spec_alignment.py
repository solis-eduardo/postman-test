...
Postman v3 (postman/collections/<COLLECTION_NAME>/**/*.request.yaml) descrevem a
...
Config: lê COLLECTION_NAME e API_VERSION de postman-fern.env (raiz do projeto).
...
KNOWN_COLLECTION_VARS = {
    ...
    "api_version": os.environ.get("API_VERSION", "v1"),       # spec usa o valor literal no path
}
...
def resolve_request_url(url_field) -> str:
    ...
    objeto estruturado. Aqui tratamos o caso string, o mais comum em v3.
    """
