 ...
 * JSON final.
 *
 * Uso (o caminho vem por argumento, já bate com o que export_v2_collection.py gera):
 *   node scripts/normalize_v2_collection.cjs "dist/<COLLECTION_NAME>.postman_collection.json"
 */
const fs = require("fs");
