...
Uso:
    ...
    (escreve dist/PetVerse API.postman_collection.json)
"""
...
OUT_PATH = ROOT / "dist" / "PetVerse API.postman_collection.json"
...
def auth_to_v2(auth_list: list[dict]) -> dict | None:
    ...
    # outros tipos de auth não usados nesta collection; adicione aqui se precisar.
    return {"type": a["type"]}
